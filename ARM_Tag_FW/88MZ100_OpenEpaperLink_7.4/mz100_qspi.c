...
__attribute__((weak)) void QSPI_IRQHandler(void)
{
  ...
  /* QSPI read fifo dma burst inerrupt */
  ...
  /* QSPI write fifo dma burst inerrupt */
  ...
  /* QSPI write fifo empty inerrupt */
  ...
  /* QSPI read fifo underflow inerrupt */
  ...
  /* QSPI read fifo overflow inerrupt */
  ...
  /* QSPI write fifo overflow inerrupt */
