...
/**
 *  @brief QSPI clock type
 */
typedef enum
{
  QSPI_POL0_PHA0,                          /*!< Inactive state of serial clock is low, data are captured on the first edge of the serial clock */
  QSPI_POL0_PHA1,                          /*!< Inactive state of serial clock is low, data are captured on the second edge of the serial clock */
  QSPI_POL1_PHA0,                          /*!< Inactive state of serial clock is high, data are captured on the first edge of the serial clock */
  QSPI_POL1_PHA1,                          /*!< Inactive state of serial clock is high, data are captured on the second edge of the serial clock */
}QSPI_ClkMode_Type;
